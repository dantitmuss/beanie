...
export default function OpponentArea({ player, sets, compact = false }: Props) {
  return (
    <div className="flex flex-col gap-2 min-w-0">
      ...
      <div className="flex flex-row gap-2 flex-wrap items-end min-h-[64px] overflow-x-auto">
        {player.hand.length > 0 && (
          <div className="flex flex-row -space-x-4">
            ...
            {player.hand.length > 5 && (
              <div
                className="w-10 h-14 rounded-[8px] bg-[#E4E4E7] flex items-center justify-center text-xs text-[#71717A] font-medium"
